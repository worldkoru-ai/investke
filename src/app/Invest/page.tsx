...
//   if (!selectedPlan || !investmentAmount) return null;
//   const amount = parseFloat(investmentAmount);
//   if (isNaN(amount)) return null; // safety check

//   const periodsPerYear: Record<string, number> = { daily: 365, weekly: 52, monthly: 12, quarterly: 4, yearly: 1 };
//   const n = periodsPerYear[selectedPlan.compoundingPeriod.toLowerCase()]; // <-- convert to lowercase
//   const r = selectedPlan.interestRate / 100;
//   const t = selectedPlan.durationDays / 365;

//   if (!n) return null; // safety check for unknown period
